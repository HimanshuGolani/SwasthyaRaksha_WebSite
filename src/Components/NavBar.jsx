  ...
  return (
    <>
      <div className="flex gap-5 justify-between self-stretch px-10 py-3.5 w-full font-bold border-b border-solid border-b-gray-200 text-neutral-900 max-md:flex-wrap max-md:px-5 max-md:max-w-full">
        ...
        {!isAuth ? (
          <div className="flex gap-2 justify-between text-sm tracking-wide leading-5 whitespace-nowrap">
            <div className="flex flex-col flex-1 justify-center px-5 py-2.5 bg-green-500 rounded-xl max-md:px-5">
              <div className="justify-center bg-green-500 aspect-[2]">
                <Link to="/login">Log in</Link>
              </div>
            </div>
            <div className="flex flex-col flex-1 justify-center px-4 py-2.5 bg-gray-100 rounded-xl">
          ...
          <div className="flex gap-5 justify-between pl-20 max-md:flex-wrap max-md:max-w-full">
            <div className="flex gap-5 justify-between py-2.5 text-sm font-medium leading-5 text-neutral-900 max-md:flex-wrap max-md:max-w-full">
              ...
              <Link to="/profile">
                <img src={profileImg} className="grow w-10 aspect-square" />
              </Link>
            </div>
          </div>
        )}
